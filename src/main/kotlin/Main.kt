fun main() {
    ...
    println(WallService.removeComment(origin.comments))     //2 Удаляем комментарий из списка комментариев
    ...
    println(WallService.editComment(originComment))         //3 Редактируем коммент
}